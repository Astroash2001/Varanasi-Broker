...
function BannerContent() {
    return (
        <div className="block text-center md:-mt-10 mt-20 py-2 lg:px-20 px-2 md:w-10/12 w-11/12 relative z-10">
            {/* Optimized Image */}
            <h1 className="text-white md:text-4xl text-xl md:leading-[3rem] font-BonaNovaRegular">Welcome to Varanasi</h1>
...
function BannerSlider() {
    ...
    const toggleDropdowntwo = () => setIsDropdownTwoOpen(!isDropdownTwoOpen);
